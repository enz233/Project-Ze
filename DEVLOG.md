...
- Added a foreground face-size gate for background camera awareness to ignore small/background faces before Vision runs.
- Added a Response Workflow layer for screen and camera tool observations so final user-visible wording is generated by ChatManager.
